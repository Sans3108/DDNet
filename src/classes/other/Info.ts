...
export class Info {
  ...
  private static async makeRequest(
    ...
    const response = await axios.get<object | string, AxiosResponse<object | string>>(url).catch((err: AxiosError) => new DDNetError('An error has occurred while fetching the information from ddnet.org!', err));
