 ...
 *
 * @see
 * [server.cpp](https://github.com/ddnet/ddnet/blob/master/src/engine/server/server.cpp#L2654-L2763)
 */
export const _Schema_MasterSrv_Info_DDRace = z.object({
  ...
  version: z.string(),
  client_score_kind: z.union([z.literal('points'), z.literal('time')]),
 ...
 */
export type MasterSrv_Info_DDRace = z.infer<typeof _Schema_MasterSrv_Info_DDRace>;
...
export function isMasterServerInfoData(
   ...
   */
  data: unknown
): data is MasterSrv_Info_DDRace {
  return _Schema_MasterSrv_Info_DDRace.safeParse(data).success;
}
...
export const _Schema_MasterSrv = z.object({
  servers: z.array(
    z.object({
      ...
      info: z.union([_Schema_MasterSrv_Info_DDRace, z.unknown()])
    })
  )
});
...
/**
 * Represents a client found on a server reported by the master.
 */
export type MasterServerClient = MasterSrv_Info_DDRace['clients'][number];
